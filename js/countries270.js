...
const southamericanCountries = countries.filter(country => country.continent === "South America");

console.log(southamericanCountries.map(country => country.name));
console.log(southamericanCountries.length);

console.log("NORTH AMERICA");
const northamericanCountries = countries.filter(country => country.continent === "North America");

console.log(northamericanCountries.map(country => country.name));
console.log(northamericanCountries.length);

console.log("OCEANIA");
const oceaniaCountries = countries.filter(country => country.continent === "Oceania");

console.log(oceaniaCountries.map(country => country.name));
console.log(oceaniaCountries.length);